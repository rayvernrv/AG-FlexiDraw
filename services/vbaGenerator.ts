export const generateVBACode = (): string => {
  return `
' ==========================================================================================
...
' 2. Press Alt+F11 -> File -> Import File -> Select this .bas file.
' 3. Press Alt+F8 -> Select "Setup_Workbook_Structure" -> Run.
'    (This creates the required Sheets and Headers for you).
' 4. Fill in your data in the "Teams", "Groups", and "Rules" sheets.
' 5. Press Alt+F8 -> Select "Main_RunDraw" -> Run.
' ==========================================================================================
...
' ==========================================================
'  HELPER: SETUP WORKBOOK STRUCTURE
'  Run this macro first to create the template sheets!
' ==========================================================
Sub Setup_Workbook_Structure()
    Dim ws As Worksheet
    
    ' 1. Setup Teams Sheet
    Set ws = GetOrCreateSheet("Teams")
    ws.Cells.Clear
    ws.Range("A1:C1").Value = Array("Name", "Organization", "Seed")
    ws.Range("A1:C1").Font.Bold = True
    ws.Range("A1:C1").Interior.Color = RGB(220, 230, 241)
    ' Sample Data
    ws.Range("A2").Value = "Player 1"
    ws.Range("B2").Value = "Club A"
    ws.Range("C2").Value = 1
    ...
    ws.Cells.Clear
    ws.Range("A1:E1").Value = Array("Rule Type", "Attribute/TeamName", "Seeds/GroupName", "MaxCount", "Active")
    ws.Range("A1:E1").Font.Bold = True
    ws.Range("A1:E1").Interior.Color = RGB(220, 230, 241)
    ' Sample Data
    ws.Range("A2").Value = "MUTUAL_EXCLUSION"
    ws.Range("B2").Value = "organization"
    ws.Range("D2").Value = 1
    ws.Range("E2").Value = True
    
    MsgBox "Workbook Setup Complete!" & vbCrLf & _
           "1. Fill in 'Teams', 'Groups', and 'Rules'." & vbCrLf & _
           "2. Run 'Main_RunDraw' to generate results.", vbInformation
End Sub
...
ErrorHandler:
    MsgBox "Error: " & Err.Description & vbCrLf & "Ensure you have sheets named 'Teams', 'Groups', and 'Rules' formatted correctly." & vbCrLf & "Tip: Run 'Setup_Workbook_Structure' macro to reset sheets.", vbExclamation
End Sub
