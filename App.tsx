    ...
    <div className="min-h-screen flex flex-col font-sans">
      ...
      <header className="bg-slate-900 text-white p-4 shadow-lg sticky top-0 z-10">
        <div className="max-w-6xl mx-auto flex items-center justify-between">
          ...
          <button 
            onClick={() => { setActiveTab('draw'); handleDraw(); }}
            className="bg-brand-600 hover:bg-brand-500 text-white px-6 py-2 rounded-full font-semibold shadow-md transition transform active:scale-95 flex items-center gap-2"
          >
            <span>Run Draw</span>
